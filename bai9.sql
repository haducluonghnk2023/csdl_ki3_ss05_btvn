...
LIMIT 3;
-- cau 4:
SELECT p.FullName AS PatientName,p.DateOfBirth,d.FullName AS DoctorName,d.Specialization,mr.Diagnosis
FROM Patients p
JOIN Appointments a ON p.PatientID = a.PatientID
JOIN Doctors d ON a.DoctorID = d.DoctorID
...
SELECT 
    ...
    p.DateOfBirth, 
    floor(DATEDIFF(a.AppointmentDate, p.DateOfBirth)/365.25) AS AgeAtAppointment,
    a.AppointmentDate, 
    a.AppointmentDate AS DiagnosisDate, 
